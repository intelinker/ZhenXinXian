...
<div class="container-fluid">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <h2>添加商家</h2>
        {!! Form::open(array('url'=>'/distributors', 'files'=>true)) !!}

        <p style="margin-top: 30px">
            <label for="title" class="col-sm-2">名称：</label>
            {!! Form::text('name', null, ['class'=>'col-sm-3', 'id'=>'name', 'required'=>'required', 'autofocus'=>'autofocus']) !!}
        </p>

        <p>
            <label for="phone" class="col-sm-2">电话：</label>
            {!! Form::text('phone', null, ['class'=>'col-sm-3', 'id'=>'price']) !!}
        </p>

        <p>
            <label for="wxid" class="col-sm-2">微信：</label>
            {!! Form::text('wxid', null, ['class'=>'col-sm-3', 'id'=>'wxid']) !!}
        </p>

        <p>
            <label for="title" class="col-sm-2">商铺：</label>
            {!! Form::text('title', null, ['class'=>'col-sm-3', 'id'=>'title']) !!}
        </p>

        <p>
            <label for="address" class="col-sm-2">地址：</label>
            {!! Form::text('address', null, ['class'=>'col-sm-3', 'id'=>'address']) !!}
        </p>
